function [Gen] = funSynMacSub_PSTN2(Gen,kTime,dt,wbase,Flag)
...
elseif Flag==2 %State eqns
    ...
    Gen.psikddot(kTime) = e/Gen.param.Td0pp;
    ...
    Gen.psikqdot(kTime) = e/Gen.param.Tq0pp;
    ...
    Gen.psikd(kTime+1) = Gen.psikd(kTime) + dt*(1.5*Gen.psikddot(kTime) - 0.5*Gen.psikddot(kTime-1));
    Gen.psikq(kTime+1) = Gen.psikq(kTime) + dt*(1.5*Gen.psikqdot(kTime) - 0.5*Gen.psikqdot(kTime-1));
