...
%===========================================================================================================
\paragraph{agc} \ \\
Calculated agc model that calculates RACE and distributes signal to defined controlled generators according to participation factor.
The ACE signal is filtered through a PI before being distributed to each generator through a unique low pass filter that adds to the governor \verb|tg_sig| value.
( NOTE: the \verb|tg_sig| value is equavelnt to an addition to the governors $P_{ref}$ value)
