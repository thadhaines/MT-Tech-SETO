...
\node [note, right of=solveNetwork1, node distance =9cm, text width = 8cm](note3){Calls \verb|nc_load| that ``computes the complex voltage V at the non-conforming load buses
