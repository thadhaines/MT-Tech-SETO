...
%% Front matter
\include{frontmatter/softDocIntro}
...
%\include{appendix/numericalTech}
%\include{appendix/largeTables}
%\include{appendix/codeExamples}
%\include{appendix/sixMachineDetails}
%\include{appendix/validations}
