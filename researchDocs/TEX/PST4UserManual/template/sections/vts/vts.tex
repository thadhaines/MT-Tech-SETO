\section{Variable Time Step Integration - WIP}  
%==============================================================================
Variable time step (VTS) simulations are possible using standard MATLAB ODE solvers.
...
To use variable time step integration methods, a user will have to create a \verb|solver_con| to a valid data file.
