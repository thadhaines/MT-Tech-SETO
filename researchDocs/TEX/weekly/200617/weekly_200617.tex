...
\chead{Research Update \\ Week of June 15th, 2020}
\lhead{Research \\ }
...
\paragraph{Recent Progress:}
	\begin{enumerate}
		...
		\item Added up select pwrmod/ivmmod examples to pstSETO
		\item Created linear/non-linear exciter and reactive load modulation examples
