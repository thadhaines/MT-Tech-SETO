...
\chead{Research Update \\ Week of June 8th, 2020}
\lhead{Research \\ }
...
\paragraph{Recent Progress:}
	\begin{enumerate}
		\itemsep0em 
		\item Incorporated pwrmod into linear and non-linear pstSETO
		\item incorporated ivmmod into non-linear pstSETO
		\item Cleaned up pwrmod/ivmmod examples
		\item Created linear exciter modulation example
		\item ...
		\item GitHub updated:\\
...
\paragraph{Current Tasks:}
	\begin{enumerate}
		\itemsep 0em 
		\item Continue to case globals to strucutred g
		\item Test models in both non-linear and linear simulations
		\item Clean up svm\_mgen\_Batch
