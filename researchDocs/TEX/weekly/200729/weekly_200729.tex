...
\paragraph{Recent Progress:}
	\begin{enumerate}
		...
		%{Created AGC example}
		\item Added Variable time step simulation via standard MATLAB ODE solvers to PST.
		\item \href{https://github.com/thadhaines/MT-Tech-SETO/blob/master/researchDocs/TEX/one-offs/200728-VTScomp1/200728-VTScomp1.pdf}{Documented initial VTS results.}		
...
\item Created \verb|handleStDx|  (and other VTS) function(s)
\item Created \verb|s_simu_BatchTestF| - a functionalized simulation script
\item Created \verb|s_simu_BatchVTS| - a variable time step script
...
\paragraph{Current Tasks:}
	\begin{enumerate}
		\itemsep 0em 
		\item Refine VTS operation (add AGC)
	...
	%					\end{minipage}
		...
		\item Create pstSETO flowchart of \verb|s_simu_BatchVTS|
...
%		\item Generate something similar to unit test cases to verify code changes don't break everything during refactor.
		...
		\item Allow for changing of solver/method during VTS.
