...
\chead{Research Update \\ Week of August 12th, 2020}
\lhead{Research \\ }
...
\paragraph{Recent Progress:}
	\begin{enumerate}
		...
		\item\href{https://github.com/thadhaines/MT-Tech-SETO/blob/master/researchDocs/TEX/one-offs/200806-ExtendedVTSdetail/200806-ExtendedVTSdetail.pdf}{Created document showing possible VTS switching issues.}
...
%	\item %\href{https://github.com/thadhaines/MT-Tech-SETO/blob/master/researchDocs/TEX/one-offs/200709-PSTsetoVersionChanges/200709-PSTsetoVersionChanges.pdf}
	%	{Updated pst SETO change doc}
		...
		\item Tested IVM in VTS, created result doc.
...
\paragraph{Current Tasks:}
	...
	\item Create long term event with pwrmod.
		...
		\item Work for PST 4.0:
		\begin{itemize}
		\scriptsize
		\itemsep0em
		\item AFTER VTS `finished'
		\item Place test VTS files into main Folder
