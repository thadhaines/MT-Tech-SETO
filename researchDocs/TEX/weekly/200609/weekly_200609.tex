...
\paragraph{Sandia Action Items:}
	\begin{itemize}
		\itemsep 0em 
		\item Review lit items related to:
			\begin{itemize}
			\itemsep 0em 
			\item multi rate methods
			\item variable time step methods
...
\paragraph{Current Tasks:}
	\begin{enumerate}
		...
		\item Cast individual globals to single structured global
