...
\chead{Research Update \\ Week of August 26th, 2020}
\lhead{Research \\ }
...
\end{comment}
	\begin{enumerate}	
		...
		\item Updated PST to version 4.0.0-aXXX
...
\paragraph{Current Tasks:}
	...
	\item Drought has lead to lower hydro output
	\item initial Low N$\longrightarrow$S Flows
	\item Solar decline as load increases %every evening
	\item inadequate dispatable generation %in CA to replace PV
	\item Leads to Large N$\longrightarrow$S Flows
	\item EIA data from 8/15/20?
	\end{itemize}
