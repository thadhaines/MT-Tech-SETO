...
%    3 1 0 7.04 0.4 6.67 1.0 7.57 0 0.2 -0.2 200 4.365 20 4.83 0.091 1.096 6.53 1 6.53; % st3 model from manual...
%   1   1   0    20   0.1 0.0 0.0 1.3  -1.15  0   0.65    2   0.67  3.0    0.813   0.05    0.7; % dc exciter from 33l3 5550 lab 2
%   2   1   0    20   0.1 0.0 0.0 1.3  -1.15  0   0.65    2   0.67  3.0   0.813   0.05    0.7; % changed to type 2
%    0       1       0       100      0.01    12.0    1.0     7.5     -6; % simple exciter w/tgr?
 %   0       1       0       212     0.01    0.0     0.0     7.5     -6   ; % simple exciter
    4       1       0       5     0.01    0.0     0.0     7.5     -6   ; % type 4 smppi
