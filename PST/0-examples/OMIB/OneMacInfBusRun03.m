...
% Load step on bus 2 of +0.25 PU at t=1 where lmod TS = 1.0 second
...
copyfile('d_OneMacInfBus03.m',[PSTpath 'DataFile.m']); % copy system data file to batch run location
...
save('OneMacInfBus03.mat'); %Save simulation outputs
