...
if printFigs
    ...
    export_fig(['AGCcomp'],'-pdf'); % to print fig
end
...
if printFigs
    set(gcf, 'Position', [1 41 1366 652])
    set(gcf,'color','w'); % to remove border of figure
    export_fig(['AGCsteps'],'-pdf'); % to print fig
end
...
if printFigs
    set(gcf,'color','w'); % to remove border of figure
    export_fig(['AGCtgSig'],'-pdf'); % to print fig
end
...
legend({'RACE 1 FTS', 'RACE 2 FTS', 'SACE 1 FTS', 'SACE 2 FTS', 'RACE VTS 1', 'RACE VTS 2', 'SACE 1 VTS', 'SACE 2 VTS'})
grid on
ylabel('MW [PU]')
xlabel('Time [sec]')
title('RACE and SACE comparisons')

if printFigs
    set(gcf,'color','w'); % to remove border of figure
    export_fig(['AGCcalcs'],'-pdf'); % to print fig
end
% %% ace signals
% figure
% 
