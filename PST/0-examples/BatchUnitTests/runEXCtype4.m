...
copyfile('d_EXC_type4.m',[PSTpath 'DataFile.m']); % copy system data file to batch run location
...
save('excT4NL.mat'); %Save all non-linear simulation outputs
...
%% save linear data
save excT4LIN.mat tL linV linSpd linPm modSig
clear all
