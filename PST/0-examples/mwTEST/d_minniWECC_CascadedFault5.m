% d_minniWECC_V3C_C3_12_TransientControl.m
% PST data file
%
% MinniWECC system, version 3C, case 3, number 12A.  Same as d_minniWECC_V3C_C3_6.m but
% 	1. removed lines 89-90, 89-38 in the pre-fault power flow by multiplying their impedances by 1e5.
% 	2. Added pss units to all generators which stablizes the oscillations in the post fault.
%   3. Removed gen 34 from the system (Alberta) by setting Albcon=0.
%   4. Set COI_P = 5; MT_P = 5 which loads the COI.
%   5. Added bus 123 connected to bus 18.  nothing is connected to bus 123. I simply use it to create a transient.
% A fault and line tripping of 18-123 is the disturbance.  For a 10 cycle fault, the system is stable.
% For a 36 cycle fault, the system is unstable with gens 1:15 separating from ges 16:33.
% A classical N-S transient instability.
%
...
%
% Modifications for Samual's research (2020)
%	Changed the lmod_con and rlmod_con buses to enable transient stability modulation throughout the system.
%	MUST USE A CONSTANT INTEGRATION STEP SIZE FOR FILTERS IN ml_sig.m
deltaT = 1/240; %Simulate at a constant rate (needed for Sam's research)
...
%Case C
    pssGen = [1:33];
    AlbCon = 0; %Alberta disconnected
%    COI_P = 20; MT_P = 5; Alberta_P = 7.5;
    COI_P = 5; MT_P = 5; Alberta_P = 20;
...
% bus    V        Angle     P_gen     Q_gen     P_load    Q_load          G       B      type QgenMax   QgenMin      V_rate vmax vmin 
  ...
  123    1.0217   -2.6446         0         0    0.0000    0.0000         0         0    3    0.0        0.0         500    1.5  0.5]; %Hv bus off of bus 18 with no load.  used for faulting.
...
%         Fbus         Tbus     R          X                    Y
          ...
          120          119            0    0.0010753            0; %Load bus 120 x-former
           ...
           24           86       0.0011       0.0211            0
           86           87     0.000756/2     0.003718/2        0;%0.001075     0.004175            0
           87          121     0.000756/2     0.003718/2        0;%0.001075     0.004175            0; %Added TCSC
           86           88       0.0012       0.0034            0
           86          121       0.0022681    0.011156          0;%0.0022       0.0084            0; %Added TCSC
          ...
          104          108      0.01275     0.041667            0
           89           38    1e5*[0.001        0.009]            0
           89           38       0.0011       0.0089            0
           89           90   1e5*[0.0011       0.0123]            0
          ...
          123           18            0     0.001               0]; %x-former to load bus 123
...
%bus Pcont Qconst P_Icont Q_Iconst
 ...
 16   0     0     1       0; %Load
 21   0     0     1       0; %Load
 24   0     0     1       0; %PDCI North, Gen 10 and 11 HV bus 
 26   0     0     1       0; %Load
 29   0     0     1       0; %Load
 36   0     0     1       0; %Load
 43   0     0     1       0; %Load
 49   0     0     1       0; %PDCI South, Gen 21 HV bus
 50   0     0     1       0; %Load
 55   0     0     1       0; %Load
 56   0     0     1       0; %Load
 64   0     0     1       0; %Load
 69   0     0     1       0; %DC North, Gen 29 HV bus 
 70   0     0     1       0; %Load
 73   0     0     1       0; %Load
 78   0     0     1       0; %Load
 95   0     0     1       0; %Load
...
120   0     0     1       0; %Load
  2   0     0     1       0; %Gen 1 HV bus
  4   0     0     1       0; %Gen 2 HV bus
  6   0     0     1       0; %Gen 3 HV bus
  7   0     0     1       0; %BC bus, no load
 79   0     0     1       0; %BC bus, no load
 80   0     0     1       0; %BC bus, no load
 10   0     0     1       0; %Gen 4 HV bus
 13   0     0     1       0; %Gen 5 HV bus
 15   0     0     1       0; %Gen 6 HV bus
 18   0     0     1       0; %Gen 7 HV bus
 20   0     0     1       0; %Gen 8 and 9 HV bus
 28   0     0     1       0; %Gen 12 HV bus
 31   0     0     1       0; %Gen 13 HV bus
 33   0     0     1       0; %Gen 14 HV bus
 35   0     0     1       0; %Gen 15 HV bus
 75   0     0     1       0; %Gen 31 HV bus
 77   0     0     1       0; %Gen 32 HV bus
 83   0     0     1       0; %North bus, no load
 88   0     0     1       0; %North bus, no load
 89   0     0     1       0; %North bus, no load
101   0     0     1       0; %North bus, no load
 38   0     0     1       0; %Gen 16 HV bus
 40   0     0     1       0; %nWest bus, no load
 42   0     0     1       0; %Gen 18 HV bus
 44   0     0     1       0; %Gen 17 HV bus
 90   0     0     1       0; %nWest bus, no load
108   0     0     1       0; %Gen 33 HV bus
114   0     0     1       0; %nWest bus, no load
 46   0     0     1       0; %Gen 19 HV bus
 52   0     0     1       0; %Gen 22 HV bus
 54   0     0     1       0; %Gen 23 HV bus
 57   0     0     1       0; %Gen 24 and 25 HV bus
 99   0     0     1       0; %sWest bus, no load
115   0     0     1       0; %Gen 20 HV bus
 61   0     0     1       0; %Gen 26 HV bus
 63   0     0     1       0; %Gen 27 HV bus
 66   0     0     1       0; %Gen 28 HV bus
 67   0     0     1       0; %East bus, no load
 72   0     0     1       0; %Gen 30 HV bus
106   0     0     1       0; %Alberta bus, no load
119   0     0     1       0; %Gen 34 HV bus
121   0     0     1       0; %TCSC bus, no load
122   0     0     1       0; %TCSC bus, no load
 96   0     0     1       0;]; %sEast bus, no load
...
%num bus  MVA  Max  Min  K  TR
  1   2   100  100 -100  1  0.05; %Gen 1 HV bus
  2   4   100  100 -100  1  0.05; %Gen 2 HV bus
  3   6   100  100 -100  1  0.05; %Gen 3 HV bus
  4  10   100  100 -100  1  0.05; %Gen 4 HV bus
  5  13   100  100 -100  1  0.05; %Gen 5 HV bus
  6  15   100  100 -100  1  0.05; %Gen 6 HV bus
  7  18   100  100 -100  1  0.05; %Gen 7 HV bus
  8  20   100  100 -100  1  0.05; %Gen 8 and 9 HV bus
  9  24   100  100 -100  1  0.05; %PDCI North, Gen 10 and 11 HV bus 
 10  28   100  100 -100  1  0.05; %Gen 12 HV bus
 11  31   100  100 -100  1  0.05; %Gen 13 HV bus
 12  33   100  100 -100  1  0.05; %Gen 14 HV bus
 13  35   100  100 -100  1  0.05; %Gen 15 HV bus
 14  38   100  100 -100  1  0.05; %Gen 16 HV bus
 15  44   100  100 -100  1  0.05; %Gen 17 HV bus
 16  42   100  100 -100  1  0.05; %Gen 18 HV bus
 17  46   100  100 -100  1  0.05; %Gen 19 HV bus
 18 115   100  100 -100  1  0.05; %Gen 20 HV bus
 19  49   100  100 -100  1  0.05; %PDCI South, Gen 21 HV bus
 20  52   100  100 -100  1  0.05; %Gen 22 HV bus
 21  54   100  100 -100  1  0.05; %Gen 23 HV bus
 22  57   100  100 -100  1  0.05; %Gen 24 and 25 HV bus
 23  61   100  100 -100  1  0.05; %Gen 26 HV bus
 24  63   100  100 -100  1  0.05; %Gen 27 HV bus
 25  66   100  100 -100  1  0.05; %Gen 28 HV bus
 26  69   100  100 -100  1  0.05; %DC North, Gen 29 HV bus 
 27  72   100  100 -100  1  0.05; %Gen 30 HV bus
 28  75   100  100 -100  1  0.05; %Gen 31 HV bus
 29  77   100  100 -100  1  0.05; %Gen 32 HV bus
 30 108   100  100 -100  1  0.05; %Gen 33 HV bus
 31 119   100  100 -100  1  0.05; %Gen 34 HV bus
 32 106   100  100 -100  1  0.05; %Alberta bus, no load
 33  79   100  100 -100  1  0.05; %BC bus, no load
 34  83   100  100 -100  1  0.05; %North bus, no load
 35 121   100  100 -100  1  0.05; %TCSC bus, no load
 36  96   100  100 -100  1  0.05; %sEast bus, no load
 37   8   100  100 -100  bus(8,6)/100   0.05; %Load
 38  11   100  100 -100  bus(11,6)/100  0.05; %Load
 39  16   100  100 -100  bus(16,6)/100  0.05; %Load
 40  21   100  100 -100  bus(21,6)/100  0.05; %Load
 41  26   100  100 -100  bus(26,6)/100  0.05; %Load
 42  29   100  100 -100  bus(29,6)/100  0.05; %Load
 43  36   100  100 -100  bus(36,6)/100  0.05; %Load
 44  43   100  100 -100  bus(43,6)/100  0.05; %Load
 45  50   100  100 -100  bus(50,6)/100  0.05; %Load
 46  55   100  100 -100  bus(55,6)/100  0.05; %Load
 47  56   100  100 -100  bus(56,6)/100  0.05; %Load
 48  64   100  100 -100  bus(64,6)/100  0.05; %Load
 49  70   100  100 -100  bus(70,6)/100  0.05; %Load
 50  73   100  100 -100  bus(73,6)/100  0.05; %Load
 51  78   100  100 -100  bus(78,6)/100  0.05; %Load
 52  95   100  100 -100  bus(95,6)/100  0.05; %Load
 53 109   100  100 -100  bus(109,6)/100 0.05; %Load
 54 112   100  100 -100  bus(112,6)/100 0.05; %Load
 55 120   100  100 -100  bus(120,6)/100 0.05]; %Load
...
%num bus  MVA  Max  Min  K  TR
 ...
 35 121   100  100 -100  1  0.05; %TCSC bus, no load
 36  96   100  100 -100  1  0.05; %sEast bus, no load
 37   8   100  100 -100  bus(8,7)/100   0.05; %Load
 38  11   100  100 -100  bus(11,7)/100  0.05; %Load
 39  16   100  100 -100  bus(16,7)/100  0.05; %Load
 40  21   100  100 -100  bus(21,7)/100  0.05; %Load
 41  26   100  100 -100  bus(26,7)/100  0.05; %Load
 42  29   100  100 -100  bus(29,7)/100  0.05; %Load
 43  36   100  100 -100  bus(36,7)/100  0.05; %Load
 44  43   100  100 -100  bus(43,7)/100  0.05; %Load
 45  50   100  100 -100  bus(50,7)/100  0.05; %Load
 46  55   100  100 -100  bus(55,7)/100  0.05; %Load
 47  56   100  100 -100  bus(56,7)/100  0.05; %Load
 48  64   100  100 -100  bus(64,7)/100  0.05; %Load
 49  70   100  100 -100  bus(70,7)/100  0.05; %Load
 50  73   100  100 -100  bus(73,7)/100  0.05; %Load
 51  78   100  100 -100  bus(78,7)/100  0.05; %Load
 52  95   100  100 -100  bus(95,7)/100  0.05; %Load
 53 109   100  100 -100  bus(109,7)/100 0.05; %Load
 54 112   100  100 -100  bus(112,7)/100 0.05; %Load
 55 120   100  100 -100  bus(120,7)/100 0.05]; %Load
...
%
% nCycle=36:
%   System goes unstable.  Gens 1:15 separate from 16:33.  Simulation fails
%   to solve 4.5 sec. after fault is released.
% nCycle-10: System is stable.
%   
nCycle = 6;
sw_con = [...
  0                 0   0    0    0    0   deltaT;%sets intitial time step
 1.0              123  18    0    0    0   deltaT; %apply fault (three phase)
 1+nCycle/60        0   0    0    0    0   deltaT; %clear near end of fault
 1+(nCycle+1)/60    0   0    0    0    0   deltaT; %clear far end of fault
 3                  0   0    0    0    0   deltaT; %increas time step
