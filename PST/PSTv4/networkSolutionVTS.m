function networkSolutionVTS(k, vts_t)
%NETWORKSOLUTIONVTS Performs the network solution for index k
% NETWORKSOLUTIONVTS Performs the network solution for index k
%
% Syntax: networkSolutionVTS(k, vts_t)
%
%   NOTES: Y-matrix switching based on vts_t (passed in time)
%
%   Input:
%   k - data index
%   vts_t - time of current step
%
%   Output:
%   VOID
%
